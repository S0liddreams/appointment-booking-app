...
import avatar from "../assets/images/doctorImg5.jpg";
            ...
            <form onSubmit={submitHandler}>
              <div className="mb-5">
                <input
                  ...
                  className="w-full pr-4 py-3 border-b border-solid border-gray-300 focus:outline-none
                ...
                <div className="relative w-[130px] h-[50px]">
                  ...
                  <label
                   ...
                   flex items-center px-[0.75rem] py-[0.375rem] text-[15px] leading-6
                    overflow-hidden bg-gray-300 text-headingColor font-semibold rounded-lg truncate cursor-pointer"
                  >
                    Upload Photo
                  </label>
                </div>
              ...
              <p className="mt-5 text-textColor text-center">
                ...
                <Link to="/login" className="text-orange-400 font-medium ml-1">
                  Login
                </Link>
              </p>
            </form>
